...
public class ProjectileCollisionBehaviour : MonoBehaviour
{
  ...
  public bool IgnoreSelfCollisionByRootName = true;
  ...
  private Vector3 forwardDirection, startPosition;
  ...
  private void Update()
  {
    ...
    if (Physics.Raycast(tRoot.position, direction, out raycastHit, distanceNextFrame + effectSettings.ColliderRadius))
    {
